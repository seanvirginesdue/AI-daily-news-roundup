...
@media only screen and (max-width:600px){{.thumb-img{{width:100% !important;height:auto !important;border-radius:8px 8px 0 0 !important;}}}}</style>
</head>
...
"""
        for _read in reads_display:
            ...
            # Image always left, text always right
            if _img:
                _left = (
                    ...
                    f'object-fit:cover;border-radius:8px 0 0 8px;" /></td>'
                )
            else:
                _left = (
